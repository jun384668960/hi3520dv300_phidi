...
#define PHIDI_AUDIO_PTNUMPERFRM   (48 * 10)//for 48k SampleRate

#define HI3520D_AUDIO_AI_DEV0 (0)
#define HI3520D_AUDIO_AI_DEV1 (1)
#define HI3520D_AUDIO_AO_DEV0 (0)
#define HI3520D_AUDIO_AO_DEV1 (1)

#define PHIDI_AUDIO_AO_HDMI    (HI3520D_AUDIO_AO_DEV1)
#define PHIDI_AUDIO_AO_CODEC   (HI3520D_AUDIO_AO_DEV0)
#define PHIDI_AUDIO_AO_DEV     (PHIDI_AUDIO_AO_HDMI)

#define PHIDI_AUDIO_AI_HDMI    (HI3520D_AUDIO_AI_DEV0)
#define PHIDI_AUDIO_AI_CODEC   (HI3520D_AUDIO_AI_DEV1)
#define PHIDI_AUDIO_AI_DEV     (PHIDI_AUDIO_AI_CODEC)
